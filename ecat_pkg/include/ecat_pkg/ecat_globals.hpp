 ...
 *******************************************************************************/
/** \mainpage Spine Surgery Robot Control Framework
 *
...
/// EtherCAT communication period in nanoseconds.
...
#define TIMESPEC2NS(T)      ((uint64_t) (T).tv_sec * g_kNsPerSec + (T).tv_nsec) /// Convert timespec struct to nanoseconds 
