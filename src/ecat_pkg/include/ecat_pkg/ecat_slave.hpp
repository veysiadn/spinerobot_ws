...
class EthercatSlave
{
    ...
    /**
     * @brief To register all PDOs at once user can create an array of PDO to register.
     * @todo  Find out if there's any IgH API function to retrieve this infos.
     *      e.g getEcPdoEntryRegT(slaveconfig,slave_pdo_regs)
     */
    /// 
