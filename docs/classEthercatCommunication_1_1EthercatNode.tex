...
\begin{DoxyCompactList}\small\item\em Defines default connected slaves based on number of slaves. Specifies its position, vendor id , product code etc. Default connected slaves considered implementation specific. In our case it will be 3 motors and one Easy\+CAT slave. \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a3dd07ec5620f136505a3a41154557898}{Set\+Cyclic\+Sync\+Position\+Mode\+Parameters}} (\mbox{\hyperlink{structCSPositionModeParam}{CSPosition\+Mode\+Param}} \&P, int position)
...
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_aa9d52ad13b5ecc696e6ab0441573cde4}{Set\+Cyclic\+Sync\+Position\+Mode\+Parameters\+All}} (\mbox{\hyperlink{structCSPositionModeParam}{CSPosition\+Mode\+Param}} \&P)
...
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a6a89e6d94328c23f8b19167412932c30}{Set\+Cyclic\+Sync\+Velocity\+Mode\+Parameters}} (\mbox{\hyperlink{structCSVelocityModeParam}{CSVelocity\+Mode\+Param}} \&P, int position)
\begin{DoxyCompactList}\small\item\em Set the Cyclic Sync Velocity Mode Parameters for slave in specified physical position w.\+r.\+t. master. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_adad463c8f6c2c4e2fb61805cfa4d5d3e}{Set\+Cyclic\+Sync\+Velocity\+Mode\+Parameters\+All}} (\mbox{\hyperlink{structCSVelocityModeParam}{CSVelocity\+Mode\+Param}} \&P)
\begin{DoxyCompactList}\small\item\em Sets the Cyclic Synchronous Velocity Mode Parameters for all connected motor driver slaves. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a3cd4836ae50c1a998e412b98aecdce77}{Set\+Cyclic\+Sync\+Torque\+Mode\+Parameters}} (\mbox{\hyperlink{structCSTorqueModeParam}{CSTorque\+Mode\+Param}} \&P, int position)
\begin{DoxyCompactList}\small\item\em Set the Cyclic Sync Torque Mode Parameters for slave in specified physical position w.\+r.\+t. master. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_ab1e699e13c478bb3ef5f73a0ba029b21}{Set\+Cyclic\+Sync\+Torque\+Mode\+Parameters\+All}} (\mbox{\hyperlink{structCSTorqueModeParam}{CSTorque\+Mode\+Param}} \&P)
\begin{DoxyCompactList}\small\item\em Sets the Cyclic Synchronous Torque Mode Parameters for all connected motor driver slaves. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a2eefc79d0eda991d04050516890801c9}{Map\+Default\+Pdos}} ()
\begin{DoxyCompactList}\small\item\em Maps default PDOs for our spine surgery robot implementation. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a659bf253ebf3a927ec6fb3519eb0bbfe}{Map\+Custom\+Pdos}} (\mbox{\hyperlink{classEthercatSlave}{Ethercat\+Slave}} c\+\_\+slave, int position)
\begin{DoxyCompactList}\small\item\em Map Custom PDO based on your PDO mappings. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em This function will check slave\textquotesingle{}s application layer states. (INIT/\+PREOP/\+SAFEOP/\+OP) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Opens Ether\+CAT master via command line tool if it\textquotesingle{}s not already on. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Get the Number Of physically Connected Slaves to the bus.\+And checks if specified NUM\+\_\+\+OF\+\_\+\+SLAVES is correct. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Shutdowns Ether\+CAT master via command line tool if it\textquotesingle{}s not already off. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Public Attributes}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classEthercatSlave}{Ethercat\+Slave}} \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_adca54bebbcfe48cb57edca8de6c3d084}{slaves\+\_\+}} \mbox{[}\mbox{\hyperlink{ecat__globals_8hpp_a5d918ecbea3b854bbfe74765c9357be3}{NUM\+\_\+\+OF\+\_\+\+SLAVES}}\mbox{]}
\end{DoxyCompactItemize}
\doxysubsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a3f8dd08c4b1cf9e455a60b8b5ae04cfb}{fd}}
\begin{DoxyCompactList}\small\item\em File descriptor to open and wake master from CLI. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This function will check slave\textquotesingle{}s application layer states. (INIT/\+PREOP/\+SAFEOP/\+OP) 
...
{\em assign\+\_\+activate} & Activating DC synchronization for slave. 0x300 for Elmo $\vert$ and same for Easy\+CAT \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
Defines default connected slaves based on number of slaves. Specifies its position, vendor id , product code etc. Default connected slaves considered implementation specific. In our case it will be 3 motors and one Easy\+CAT slave. 
...
Get the Number Of physically Connected Slaves to the bus.\+And checks if specified NUM\+\_\+\+OF\+\_\+\+SLAVES is correct. 

\begin{DoxyReturn}{Returns}
0 if NUM\+\_\+\+OF\+\_\+\+SLAVES setting is correct, otherwise -\/1. 
\end{DoxyReturn}
\mbox{\Hypertarget{classEthercatCommunication_1_1EthercatNode_a659bf253ebf3a927ec6fb3519eb0bbfe}\label{classEthercatCommunication_1_1EthercatNode_a659bf253ebf3a927ec6fb3519eb0bbfe}} 
...
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Map\+Custom\+Pdos (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classEthercatSlave}{Ethercat\+Slave}}}]{c\+\_\+slave,  }\item[{int}]{position }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em c\+\_\+slave} & \mbox{\hyperlink{classEthercatSlave}{Ethercat\+Slave}} instance \\
\hline
...
Maps default PDOs for our spine surgery robot implementation. 

\begin{DoxyNote}{Note}
This method is specific for our spinerobot implementation. If you have different topology or different servo drives use 
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classEthercatCommunication_1_1EthercatNode_a659bf253ebf3a927ec6fb3519eb0bbfe}{Map\+Custom\+Pdos()}} function of modify this function based on your needs. 
\end{DoxySeeAlso}
\begin{DoxyReturn}{Returns}
0 if succesfull, otherwise -\/1. 
\end{DoxyReturn}
This part is specific for our Custom EASYCAT slave configuration To create your custom slave and variables you can add variables to \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{structOffsetPDO}{Offset\+PDO}} struct. Also you have add your variables to received data structure, you may have to create your custom msg files as well.
\end{DoxySeeAlso}
...
Opens Ether\+CAT master via command line tool if it\textquotesingle{}s not already on. 
...
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Position\+Mode\+Parameters (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSPositionModeParam}{CSPosition\+Mode\+Param}} \&}]{P,  }\item[{int}]{position }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Position\+Mode\+Parameters\+All (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSPositionModeParam}{CSPosition\+Mode\+Param}} \&}]{P }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classEthercatCommunication_1_1EthercatNode_a3cd4836ae50c1a998e412b98aecdce77}\label{classEthercatCommunication_1_1EthercatNode_a3cd4836ae50c1a998e412b98aecdce77}} 
\index{EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}!SetCyclicSyncTorqueModeParameters@{SetCyclicSyncTorqueModeParameters}}
\index{SetCyclicSyncTorqueModeParameters@{SetCyclicSyncTorqueModeParameters}!EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}}
\doxysubsubsection{\texorpdfstring{SetCyclicSyncTorqueModeParameters()}{SetCyclicSyncTorqueModeParameters()}}
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Torque\+Mode\+Parameters (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSTorqueModeParam}{CSTorque\+Mode\+Param}} \&}]{P,  }\item[{int}]{position }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em P} & Cyclic Sync. Torque Mode Parameters. \\
\hline
{\em position} & Physical position of slave to be configured \\
\hline
\end{DoxyParams}
...
0 if sucessfull, otherwise -\/1. 
\end{DoxyReturn}
\mbox{\Hypertarget{classEthercatCommunication_1_1EthercatNode_ab1e699e13c478bb3ef5f73a0ba029b21}\label{classEthercatCommunication_1_1EthercatNode_ab1e699e13c478bb3ef5f73a0ba029b21}} 
\index{EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}!SetCyclicSyncTorqueModeParametersAll@{SetCyclicSyncTorqueModeParametersAll}}
\index{SetCyclicSyncTorqueModeParametersAll@{SetCyclicSyncTorqueModeParametersAll}!EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}}
\doxysubsubsection{\texorpdfstring{SetCyclicSyncTorqueModeParametersAll()}{SetCyclicSyncTorqueModeParametersAll()}}
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Torque\+Mode\+Parameters\+All (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSTorqueModeParam}{CSTorque\+Mode\+Param}} \&}]{P }\end{DoxyParamCaption})}
...
0 if sucessful, otherwise -\/1. 
\end{DoxyReturn}
\mbox{\Hypertarget{classEthercatCommunication_1_1EthercatNode_a6a89e6d94328c23f8b19167412932c30}\label{classEthercatCommunication_1_1EthercatNode_a6a89e6d94328c23f8b19167412932c30}} 
\index{EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}!SetCyclicSyncVelocityModeParameters@{SetCyclicSyncVelocityModeParameters}}
\index{SetCyclicSyncVelocityModeParameters@{SetCyclicSyncVelocityModeParameters}!EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}}
\doxysubsubsection{\texorpdfstring{SetCyclicSyncVelocityModeParameters()}{SetCyclicSyncVelocityModeParameters()}}
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Velocity\+Mode\+Parameters (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSVelocityModeParam}{CSVelocity\+Mode\+Param}} \&}]{P,  }\item[{int}]{position }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em P} & Cyclic Sync. Velocity Mode Parameters. \\
\hline
{\em position} & Physical position of slave to be configured \\
\hline
\end{DoxyParams}
...
0 if sucessfull, otherwise -\/1. 
\end{DoxyReturn}
\mbox{\Hypertarget{classEthercatCommunication_1_1EthercatNode_adad463c8f6c2c4e2fb61805cfa4d5d3e}\label{classEthercatCommunication_1_1EthercatNode_adad463c8f6c2c4e2fb61805cfa4d5d3e}} 
\index{EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}!SetCyclicSyncVelocityModeParametersAll@{SetCyclicSyncVelocityModeParametersAll}}
\index{SetCyclicSyncVelocityModeParametersAll@{SetCyclicSyncVelocityModeParametersAll}!EthercatCommunication::EthercatNode@{EthercatCommunication::EthercatNode}}
\doxysubsubsection{\texorpdfstring{SetCyclicSyncVelocityModeParametersAll()}{SetCyclicSyncVelocityModeParametersAll()}}
{\footnotesize\ttfamily int Ethercat\+Node\+::\+Set\+Cyclic\+Sync\+Velocity\+Mode\+Parameters\+All (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCSVelocityModeParam}{CSVelocity\+Mode\+Param}} \&}]{P }\end{DoxyParamCaption})}
...
Shutdowns Ether\+CAT master via command line tool if it\textquotesingle{}s not already off. 
...
{\footnotesize\ttfamily \mbox{\hyperlink{classEthercatSlave}{Ethercat\+Slave}} Ethercat\+Communication\+::\+Ethercat\+Node\+::slaves\+\_\+\mbox{[}\mbox{\hyperlink{ecat__globals_8hpp_a5d918ecbea3b854bbfe74765c9357be3}{NUM\+\_\+\+OF\+\_\+\+SLAVES}}\mbox{]}}



The documentation for this class was generated from the following files\+:\begin{DoxyCompactItemize}
\item 
src/ecat\+\_\+pkg/include/ecat\+\_\+pkg/\mbox{\hyperlink{ecat__node_8hpp}{ecat\+\_\+node.\+hpp}}\item 
src/ecat\+\_\+pkg/src/\mbox{\hyperlink{ecat__node_8cpp}{ecat\+\_\+node.\+cpp}}\end{DoxyCompactItemize}
