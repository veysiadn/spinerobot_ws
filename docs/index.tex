...
Please check guides, links and documentations before installation, or using this control framework.\hypertarget{index_autotoc_md1}{}\doxysection{Guides}\label{index_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysection{Prerequisites}\label{index_autotoc_md2}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysection{Implementation}\label{index_autotoc_md3}

\begin{DoxyCode}{0}
\DoxyCodeLine{git clone https://github.com/veysiadn/spinerobot\_ws}
\DoxyCodeLine{sudo -\/s}
